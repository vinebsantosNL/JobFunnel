...
Search the codebase and existing docs (CLAUDE.md, `.agent/skills/`) for related specs or prior decisions to avoid duplicating an existing story or contradicting an approved direction. If no relevant context is found, proceed from what the user provides.
