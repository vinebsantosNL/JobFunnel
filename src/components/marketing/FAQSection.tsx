...
const faqs = [
  ...
  },
  {
    ...
    a: "The core insight is your conversion rate at each stage of your search: Applied → Screening, Screening → Interviewing, Interviewing → Offer. You can see how those rates compare to EU benchmarks for your role type. You can see which applications are stalling (time-in-stage). And if you're running two CV versions, you can see which one correlates with better outcomes. These are the insights that let you diagnose what's broken — not just describe what happened.",
  },
  {
            ...
            return (
              <div key={i} className="py-5">
                <button
                  ...
                  className="flex items-start justify-between w-full gap-6 text-left group min-h-[44px]"
                ...
                >
                  ...
                  <svg
                    ...
                    fill="none"
                    className={[
                      'flex-shrink-0 mt-0.5 transition-transform duration-200 text-[#94A3B8]',
                      isOpen ? 'rotate-45' : '',
                    ].join(' ')}
                  >
                    <path
                ...
                >
                  <div className="overflow-hidden">
                    <p className="pt-4 text-sm text-[#64748B] leading-relaxed">{faq.a}</p>
                  </div>
                </div>
              </div>
            )
